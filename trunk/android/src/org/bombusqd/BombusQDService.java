...
public class BombusQDService extends Service {
    ...
    private static final String LOG_TAG = "BombusQDService";
    ...
    public void onCreate() {
        ...
        notification.setLatestEventInfo(this, getText(R.string.app_name), "Application is running", contentIntent);
